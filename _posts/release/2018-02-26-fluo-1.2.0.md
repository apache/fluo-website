...
With Apache Fluo, users can set up workflows that execute cross node
...
Apache Fluo is an open source implementation [Percolator] (which populates
Google's search index) that is built on [Apache Accumulo].
