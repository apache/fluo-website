 ...
 * Configuration for the test committed and tagged in git : [muchos tag][fd-tag-1] and [stresso tag][fs-tag-1]
 * Opened two issues as a result of test [#499][499] and [stresso#30][fs-30]
